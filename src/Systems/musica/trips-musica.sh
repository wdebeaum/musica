...
echo 'This is TRIPS/MUSICA version 0'
...
(sleep 5; \
 $TRIPS_BASE/bin/TextTagger \
     ...
     -default-type '(or affixes words punctuation terms-from-file roman-numerals music word-net)' \
